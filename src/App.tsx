...
const AircraftCard: React.FC<{ plane: Aircraft }> = ({ plane }) => {
  const [imgError, setImgError] = useState(false);
            ...
            <div className="relative z-20 text-center px-6 mt-10 md:mt-20 max-w-5xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-4 mb-6">
                ...
                <h1 className="text-4xl md:text-8xl font-black uppercase tracking-tighter mb-4 leading-none">
                  GÖKTÜRK <br />
                  <span className="text-white glow-text italic underline decoration-blue-600 decoration-4 md:decoration-8">İHA EKİBİ</span>
                </h1>
              </div>
